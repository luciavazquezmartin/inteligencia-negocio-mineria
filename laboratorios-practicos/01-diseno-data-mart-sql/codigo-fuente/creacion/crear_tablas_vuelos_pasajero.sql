-- ============================================================================
-- SCRIPT DE CREACIÓN: DATA MART VUELOS CON PASAJEROS
-- ============================================================================
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE GRUPO_PASAJEROS CASCADE CONSTRAINTS';
    EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE GRUPO CASCADE CONSTRAINTS';
    EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
-- 7. PASAJERO (dimensión de pasajeros)
...
-- 8. GRUPO (tabla auxiliar para grupos de pasajeros)
CREATE TABLE GRUPO (
    id_grupo INTEGER PRIMARY KEY
);

-- 9. GRUPO_PASAJEROS (tabla puente - relación muchos a muchos)
...
-- 10. VUELO (tabla de hechos central)
CREATE TABLE VUELO (
